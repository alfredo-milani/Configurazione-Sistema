...
disable_cores="Disable Cores;$script_path/check_psw.sh $script_path/manage_cores.sh /;'<Ctrl><Shift>D'";
enable_cores="Enable Cores;$script_path/check_psw.sh $script_path/manage_cores.sh °°;'<Ctrl><Shift>E'";
